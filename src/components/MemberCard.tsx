  ...
  return (
    <div className="relative w-[340px] h-[540px] rounded-3xl overflow-hidden shadow-[var(--shadow-card)] font-sans">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <img src={logo} alt="" className="w-[80%] opacity-[0.07]" />
      </div>
      ...
      <CardShell isOfficer={isOfficer} variant={`${variant}-b`}>
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-[8px] tracking-[0.18em] opacity-80">DADOS DO ASSOCIADO</p>
            <h2 className="text-sm font-bold tracking-wider">ASSOCIAÇÃO PENAL BAHIA</h2>
          </div>
        </div>
        <div className="h-px my-3" style={{ background: "var(--gradient-gold)", opacity: 0.6 }} />
        ...
        <div
          ...
          style={{ borderColor: "oklch(0.78 0.14 80 / 0.4)", background: "oklch(0 0 0 / 0.25)" }}
        >
          <p
          ...
          <p className="text-[9px] leading-relaxed opacity-90">
            O portador é membro associado da Associação Penal Bahia, com livre acesso aos
            espaços institucionais conforme estatuto vigente.
          </p>
        </div>
        ...
        <div className="mt-auto pt-3 border-t border-white/15 flex items-center justify-between">
          ...
          <p className="text-lg font-black tracking-widest" style={{ color: "oklch(0.78 0.14 80)" }}>
            APB
          </p>
        </div>
      </CardShell>
